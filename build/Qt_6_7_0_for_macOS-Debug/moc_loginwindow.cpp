...
Q_CONSTINIT const QMetaObject LoginWindow::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSLoginWindowENDCLASS_t,
        ...
        // method 'showAuthWindow'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'showRegisterWindow'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'openAuthWindow'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'openRegisterWindow'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void LoginWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->openAuthWindow(); break;
        case 3: _t->openRegisterWindow(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &LoginWindow::showAuthWindow; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (LoginWindow::*)();
            if (_t _q_method = &LoginWindow::showRegisterWindow; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void LoginWindow::showAuthWindow()
{
